...
train_dataset = train.flow_from_directory(directory='C:/Users/user/Downloads/archive/seg_train/seg_train',target_size=(50,50),shuffle=True)
test_dataset = test.flow_from_directory(directory='C:/Users/user/Downloads/archive/seg_test/seg_test',target_size=(50,50),shuffle=True)
...
history = model.fit(train_dataset,batch_size=80,epochs=6,validation_data=test_dataset)
